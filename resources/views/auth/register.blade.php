<x-guest-layout>
    ...
    <div class="min-h-screen pt-20 pb-12 loginbg">
        <div class="container px-4 mx-auto">
            <div class="max-w-md mx-auto">
                <div class="p-8 bg-white shadow-2xl glass-card register-form-container rounded-2xl">
                    <!-- Header -->
                    <div class="mb-8 text-center">
                        <div class="flex items-center justify-center w-16 h-16 mx-auto mb-4 bg-indigo-600 rounded-full">
                            <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" />
                            </svg>
                        </div>
                        <h1 class="mb-2 text-2xl font-bold text-gray-900">{{ __('加入我們') }}</h1>
                    ...
                    <form method="POST" action="{{ route('register') }}" class="space-y-6">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <x-label for="last_name" class="block mb-2 text-sm font-medium text-gray-700">
                                ...
                                <x-input
                                    id="last_name"
                                    class="block w-full px-4 py-3 transition border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                                    type="text"
                                    name="last_name"
                                    :value="old('last_name')"
                                    required
                            ...
                            <div>
                                <x-label for="first_name" class="block mb-2 text-sm font-medium text-gray-700">
                        ...
                        <!-- Email Field -->
                        <div>
                            <x-label for="email" class="block mb-2 text-sm font-medium text-gray-700">
                                <svg class="inline w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <!-- Username Field -->
                        <div>
                            <x-label for="username" class="block mb-2 text-sm font-medium text-gray-700">
                                <svg class="inline w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <!-- Password Field -->
                        <div>
                            <x-label for="password" class="block mb-2 text-sm font-medium text-gray-700">
                                <svg class="inline w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="relative">
                                <x-input
                                    id="password"
                                    class="block w-full px-4 py-3 pr-10 transition border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                                    type="password"
                                    name="password"
                                    required
                            ...
                            <div class="flex gap-1 mt-2">
                                <div id="strength1" class="flex-1 h-1 transition-colors duration-300 bg-gray-200 rounded"></div>
                                <div id="strength2" class="flex-1 h-1 transition-colors duration-300 bg-gray-200 rounded"></div>
                                <div id="strength3" class="flex-1 h-1 transition-colors duration-300 bg-gray-200 rounded"></div>
                            </div>
                            <p id="strengthText" class="mt-1 text-xs text-gray-500">{{ __('密碼強度') }}</p>
                        </div>

                        <!-- Confirm Password Field -->
                        <div>
                            <x-label for="password_confirmation" class="block mb-2 text-sm font-medium text-gray-700">
                                <svg class="inline w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                                </svg>
                                {{ __('確認密碼') }}
